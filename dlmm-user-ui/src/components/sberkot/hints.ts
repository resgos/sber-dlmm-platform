...
export const HINTS: Array<{ match: (p: string) => boolean } & Hint> = [
  ...
  },
  {
    ...
    text: 'Здесь всё просто: выберите токен, сумму и нажмите Купить или Продать. Ликвидность добавляется по базовым настройкам. Хотите бины и стратегии — переключитесь в Pro вверху.',
  },
  {
