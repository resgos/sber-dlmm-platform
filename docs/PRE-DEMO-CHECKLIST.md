# Pre-Demo Checklist (updated 2026-06-12)
...
> ✅ **Мобильная + тёмная тема — верифицированы 2026-06-12** (hourly-loop):
> 375×812 — ноль горизонтального оверфлоу на 6 маршрутах (дашборд, пулы,
> пул-детально, своп, транзакции, позиции); `prefers-color-scheme: dark`
> подхватывается автоматически (`data-theme="dark"`), контраст-скан ~600
> текстовых элементов на трёх страницах — 0 пар ниже 2.2:1. Если показываете
> с планшета — отдельной подготовки не требуется.
